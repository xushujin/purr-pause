...
```
dist/purr-pause_1.1.1_amd64.deb
```

### 安装测试

```bash
sudo dpkg -i dist/purr-pause_1.1.1_amd64.deb
```
...
```
dist/purr-pause-1.1.1.dmg
dist/purr-pause-1.1.1-arm64.dmg  (Apple Silicon)
```
...
```
dist/purr-pause-Setup-1.1.1.exe
```
